...
describe('GET /companies', function () {
  ...
  test('Test for filter of companies by name', async function () {
  ...
  test('Test for filter of companies by maxEmployees', async function () {
  ...
  test('Test for filter of companies by minEmployees', async function () {
  ...
  test('Test for minEmployees value greater than maxEmployees', async function () {
    const resp = await request(app).get(
      '/companies?minEmployees=5&maxEmployees=2'
    );
...
describe('DELETE /companies/:handle', function () {
  test('works for isAdmin only', async function () {
    const resp = await request(app)
      .delete(`/companies/c1`)
      .set('authorization', `Bearer ${u4Token}`);
